...
<!--&lt;!&ndash;            <el-input v-model="dataForm.select" clearable placeholder="请输入用户名"></el-input>&ndash;&gt;-->
<!--&lt;!&ndash;          </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;          <el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-button type="info" icon="el-icon-search" @click="getDataList">查询</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-button type="primary" @click="openAddDialog()">新增</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;          </el-form-item>&ndash;&gt;-->
<!--        </el-form>-->
...
<!--              <el-button size="mini" type="primary" @click="handleCommand">修改密码</el-button>-->
...
<!--        </el-pagination>-->
      ...
      <!-- Form -->
<!--      <el-dialog title="修改密码" :visible.sync="dialogFormVisible" width="30%" @close="closeDialogOne()">-->
...
<!--          </el-form-item>-->
<!--          <el-form-item>-->
<!--            <el-button type="primary" @click="handleSubmitFormDataOne('passwordForm')">确定</el-button>-->
<!--            <el-button @click="dialogFormVisible = false">取 消</el-button>-->
<!--          </el-form-item>-->
<!--        </el-form>-->
<!--      </el-dialog>-->
...
export default {
  ...
  methods: {
    ...
    handleSubmitFormDataOne(passwordForm) {
    ...
    getDataList() {
      ...
      //后端请求 分页获取对象
      this.$http.get("/admin/getOne",params).then((res) => {
