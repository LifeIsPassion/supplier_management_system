    ...
    <el-card class="box-card">
      <div class="mod-role">
        <el-form :inline="true" :model="dataForm" class="demo-form-inline">
          <el-form-item>
            <el-input v-model="dataForm.supplier" clearable placeholder="请输入负责人名称"></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <el-table :data="dataList" style="width: 100%">
          ...
          <el-table-column prop="reviewStatus" label="审核状态" width="120" show-overflow-tooltip>
            <template slot-scope="scope">
              <span>{{ scope.row.reviewStatus == 0 ? '已审核' : '待审核' }}</span>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    openDialog() {
      ...
      this.dataDialogForm.head = sessionStorage.getItem("username");
    ...
    getDataList() {
      ...
      //后端请求
      this.$http.get("/supplier/listSupplier", params).then((res) => {
